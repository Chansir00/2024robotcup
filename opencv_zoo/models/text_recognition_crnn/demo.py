...
sys.path.append('opencv_zoo\models\text_detection_db')
from db import DB
...
if __name__ == '__main__':
    ...
    detector = DB(modelPath=r'opencv_zoo\models\text_recognition_crnn\text_recognition_CRNN_EN_2023feb_fp16.onnx',
