...
parser.add_argument('--model', '-m', type=str, default='2023/main fv/opencv_zoo/models/text_detection_db/text_detection_DB_IC15_resnet18_2021sep.onnx',
                    help='Usage: Set model path, defaults to text_detection_DB_TD500_resnet18_2021sep.onnx.')
parser.add_argument('--backend_target', '-bt', type=int, default=2,
